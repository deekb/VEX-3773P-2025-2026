...
class TelemetryInteger(TelemetryEntry):
...
class TelemetryMotorEntry(TelemetryEntry):
    ...
    def set_value(self, value):
        raise RuntimeError("Can't set the value of a Motor entry")
...
class TelemetryInertialEntry(TelemetryEntry):
    ...
    def set_value(self, value):
        raise RuntimeError("Can't set the value of an Inertial entry")
