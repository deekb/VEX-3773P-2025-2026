...
class UARTCommunicationProtocol:
    def __init__(self):
        self.incoming_messages = SafeList()
        self.outgoing_messages = SafeList()
    ...
    def get_loop(self):
        while True:
            got = self.file_handle.readline().strip("\n")
            if got:
    ...
    def send_loop(self):
        while True:
            if self.has_outgoing_messages():
                self.file_handle.write(str(self.outgoing_messages.pop(0)) + "\n")
...
class Telemetry:
    def __init__(self):
        ...
        self.serial = UARTCommunicationProtocol()
