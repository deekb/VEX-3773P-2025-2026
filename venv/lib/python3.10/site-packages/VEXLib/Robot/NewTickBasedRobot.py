...
from VEXLib.Robot.Constants import DRIVER_CONTROL, AUTONOMOUS_CONTROL, TARGET_TICK_DURATION_MS, \
    WARNING_TICK_DURATION_MS
from VEXLib.Robot.RobotBase import RobotBase
from collections import namedtuple

GameState = namedtuple('GameState', ['mode', 'enabled'])

DRIVER_CONTROL_ENABLED = GameState(DRIVER_CONTROL, True)
DRIVER_CONTROL_DISABLED = GameState(DRIVER_CONTROL, False)
AUTONOMOUS_CONTROL_ENABLED = GameState(AUTONOMOUS_CONTROL, True)
AUTONOMOUS_CONTROL_DISABLED = GameState(AUTONOMOUS_CONTROL, False)
