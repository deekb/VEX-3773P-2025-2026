from VEXLib.Network.Telemetry import Telemetry, TelemetryMotorEntry
from VEXLib.Robot import TickBasedRobot
from vex import Motor, Brain


class TelemetryTickBasedRobot(TickBasedRobot):
    ...
    def register_telemetry(self):
        ...
        for name, _object in objects.items():
            ...
            if isinstance(_object, Motor):
                ...
                self.telemetry_objects.append(TelemetryMotorEntry(self.telemetry, _object, "Motor " + motor_port))
            else:
