...
class RobotBase:
    def __init__(self, brain: Brain):
        # Create a new competition object and initialize the callbacks for driver and autonomous control to a universal lambda pass function
        # This is because we would like to handle running the state machine and callbacks ourselves for more predictable behaviours and to allow injecting additional functionality
