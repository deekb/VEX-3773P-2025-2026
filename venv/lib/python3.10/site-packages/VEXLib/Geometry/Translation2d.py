...
class Translation2d:
    ...
    def rotate_by(self, rotation2d: Rotation2d):
        sin_angle = rotation2d.sin()
        cos_angle = rotation2d.cos()

        new_x = self.x_component.to_meters() * cos_angle - self.y_component.to_meters() * sin_angle
        new_y = self.x_component.to_meters() * sin_angle + self.y_component.to_meters() * cos_angle
