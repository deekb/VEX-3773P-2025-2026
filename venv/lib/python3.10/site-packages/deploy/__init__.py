...
def main():
    ...
    required_libraries = detect_dependencies(SRC_DIRECTORY, MAIN_PROGRAM, available_libraries, VEX_BUILTIN_MODULES)
    ...
    with console.status("[cyan]Unmounting drive please wait [yellow]:warning:") as status:
        time.sleep(1)  # Give the device time to finish writing files
