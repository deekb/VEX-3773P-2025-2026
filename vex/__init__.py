...
class VoltageUnits:
    ...
    """A voltage unit that is measured in milli volts."""
...
class AnalogUnits:
    ...
    MV = AnalogUnits(0, "MV")
    """An analog unit that is measured in milli volts."""
...
class Brain:
    ...
    class Lcd:
        ...
        def clear_row(self, number=None, color=Color.BLACK):
            ...
            The color can be passed in similar ways to the Color class.\\
             ...
             Arguments:
                number (optional) : The row to clear, default is current cursor row
                color (optional) : The color the screen will be set to, default is BLACK
        ...
        def print(self, *args, sep=" ", precision=4):
        ...
        def print_at(self, x, y, sep=" ", precision=4, opaque=True):
        ...
        def render(self):
            """ Switch drawing to double buffered and render to screen.
    ...
    class Sdcard:
        ...
        def is_inserted(self):
            ...
            Returns:
               True if a sdcard is inserted into the brain
        ...
        def loadfile(self, filename: str, buffer: bytearray):
            """ load the named file
        ...
        def savefile(self, filename: str, buffer: bytearray):
        ...
        def appendfile(self, filename: str, buffer: bytearray):
    ...
    class Lcd:
        ...
        def clear_row(self, number: vexnumber):
            """ Clear screen row
             ...
             Arguments:
                number (optional) : The row to clear, 1, 2, or 3, default is current cursor row
...
class Gps:
    """ Gps class - a class for working with the gps sensor
     ...
     Arguments:
        port : The smart port this device is attached to
...
class Inertial:
    ...
    def calibrate(self):
        ...
        Calibration should be done when the inertial sensor is not moving.
...
class Motor:
    ...
    def spin(self, direction: DirectionType.DirectionType, velocity=None, units=RPM):
        """ Spin the motor using the provided arguments
         ...
         Examples:
            ...
            # spin with negative velocity, i.e. backwards\\
    ...
    def spin_to_position(
        self, rotation: vexnumber, units=RPM, velocity=None, units_v=RPM, wait=False
    ):
    ...
    def spin_for(
        ...
        The position is relative (i.e. an offset) to the current position\\
        This function supports keyword arguments.

         Arguments:
            direction : The direction to spin the motor, FORWARD or REVERSE
            rot_or_time : The relative position to spin the motor to or the amount of time to spin for
...
class Timer:
    ...
    def time(self, units=TimeUnits.MSEC):
        ...
        Returns:
            The current time in specified units.
    ...
    def event(self, callback: Callable[..., None], delay: int, arg: tuple = ()):
        """ register a function to be called in the future
         ...
         Arguments:
            callback : A function that will be called after the supplied delay.
...
class ObjectDetector:
    ...
    def set_threshold(
        ...
        Arguments:
           ...
           units: The unit for hte threshold, only PERCENT appears to be supported
...
class Gyro:
    ...
    def calibrate(self):
        ...
        Calibration should be done when the gyro is not moving.
...
class Sonar:
    ...
    valid port pairs are a/b, c/d, e/f and g/h\\
    connect the wire labeled "output" to the lower 3wire port, e.g. a
...
class Tagdesc:
    def __init__(self, index):
        """Tag Descriptor class - a class for holding AI vision sensor tag id

        A tag description holds an apriltag id
         Arguments:
            index : The apriltag id (positive integer, not 0)

         Returns:
            An instance of the Tag Descriptor class

         Examples:
            T1 = Tag Descriptor( 23 )
        """
        self.id = index
        pass
...
class AiObjdesc:
    def __init__(self, index):
        """Ai Object Descriptor class - a class for holding AI vision sensor AI object id

        A tag description holds an apriltag id
         Arguments:
            index : The AI Object (model) id (positive integer, not 0)

         Returns:
            An instance of the Ai Object Descriptor class

         Examples:
            A1 = Ai Object Descriptor( 2 )
        """
        self.id = index
        pass
...
class AiVision:
    """ AI Vision class - a class for working with the AI Vision sensor
     ...
     Arguments:
        port : The smart port this device is attached to
        colors (optional) : one or more Color Descriptor objects
        codes (optional) : one or more Color Descriptor objects
    ...
    TAG_CIRCLE21H7 = 0
    """Apriltag family circle21h7, used with set_tag_family"""
    TAG_16H5 = 1
    """Apriltag family 16h5, used with set_tag_family"""
    TAG_25H9 = 2
    """Apriltag family 25h9, used with set_tag_family"""
    TAG_36H11 = 3
    """Apriltag family 36h11, used with set_tag_family"""
...
class MessageLink:
    ...
    Arguments:
       port : The smart port the VEXlink radio is attached to
    ...
    def send(self, message: str, index, value):
    ...
    def received(self, message, callback):
...
class SerialLink:
    ...
    def send(self, buffer):
        """ Send a buffer of a certain length
...
class Optical:
    ...
    def set_light_power(
        ...
        Arguments:
           ...
           units: The unit to set it in, only PERCENT appears to be supported
...
class Electromagnet:
    ...
    def pickup(self, duration=1000, units=MSEC, power=50):
        """ energize the electromagnet to pickup objects
         ...
         Arguments:
            duration (optional) : the duration to energize the magnet for, default is one-second
    ...
    def is_spinning(self):
        ...
        It will return True if any motor is still spinning or False if they have completed the move or a timeout occurred.
         ...
         Returns:
            The current spin_to_position or spin_for status
        """
        is_any_motor_spinning = False
        for m in self._motors:
            is_any_motor_spinning = is_any_motor_spinning or m.is_spinning()
        return is_any_motor_spinning

    def is_spinning_mode(self):
        is_any_motor_spinning_mode = False
        for m in self._motors:
            is_any_motor_spinning_mode = is_any_motor_spinning_mode or m.is_spinning_mode()
        return is_any_motor_spinning_mode
...
class DriveTrain:
    """ DriveTrain class - use this to create a simple drivetrain
     ...
     Arguments:
        ...
        trackWidth (optional) : The track width of the drivetrain, default is 320 mm
    ...
    def drive(
        ...
        all drive motors are commanded using the provided parameters.
         ...
         Examples:
            ...
            # drive with negative velocity, i.e. backwards\\
