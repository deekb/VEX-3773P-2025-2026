...
relative_code = """import WallStakeMechanism as WallStakeMechanism
...
def negative(robot):
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-20), -30, ramp_up=False, turn_first=True)
...
def skills_alliance_stake(robot):
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-50), 0, ramp_down=False)
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    time.sleep(0.5)
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(27), -55)
