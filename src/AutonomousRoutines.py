...
def new_skills_alliance_stake(robot):
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(91), -45)
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(38), -90)
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(28), 40)
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(80), 50)
    robot.scoring_mechanism.spin_upper_intake(-40)
    time.sleep(0.2)
    robot.scoring_mechanism.spin_upper_intake(0)
