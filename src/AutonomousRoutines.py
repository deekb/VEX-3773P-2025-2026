...
def new_skills_alliance_stake(robot):
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(1.3, 1.3))
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(92), -45)
    ...
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(1.3 * 0.9, 1.3))
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(170), 180)
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(1.3, 1.3))
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(32), 40)

    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-188), -88)
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(89), 50)
    robot.scoring_mechanism.spin_upper_intake(-40)
    stop_and_sleep(robot, 0.2)
    robot.scoring_mechanism.spin_upper_intake(0)
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(35), -45)
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(140), 87)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-30), 87)
...
def third_win_point_states(robot):
    ...
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-30), 55)
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-95), 145)
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    stop_and_sleep(robot, 0.5)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(5), -90)
    robot.mobile_goal_clamp.release_mobile_goal()
    schedule_function(0.1, robot.scoring_mechanism.intake_until_ring)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(60), -90)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-43), 180)
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.wall_stake_mechanism.transition_to(WallStakeState.LOW_SCORING)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(-80), -135)
    robot.drivetrain.move_distance_towards_direction_trap(Translation1d.from_centimeters(80), 45)
...
available_autos = [new_skills_alliance_stake, win_point_states, third_win_point_states]
