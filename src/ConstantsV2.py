...
class CompetitionSmartPorts:
    ...
    FRONT_LEFT_DRIVETRAIN_MOTOR = Ports.PORT2
    REAR_LOWER_LEFT_DRIVETRAIN_MOTOR = Ports.PORT4
    REAR_UPPER_LEFT_DRIVETRAIN_MOTOR = Ports.PORT8

    FRONT_RIGHT_DRIVETRAIN_MOTOR = Ports.PORT6
    REAR_LOWER_RIGHT_DRIVETRAIN_MOTOR = Ports.PORT3
    REAR_UPPER_RIGHT_DRIVETRAIN_MOTOR = Ports.PORT5

    UPPER_INTAKE_MOTOR = Ports.PORT20
    HOOD_MOTOR = Ports.PORT9
