...
def bonk(robot):
    robot.wall_stake_mechanism.transition_to(
        WallStakeMechanism.WallStakeState.HIGH_SCORING
    )
...
def negative_point_based(robot):
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-25.0, 0.0), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-85.622, 35.0), use_back=True
    )

    robot.mobile_goal_clamp.clamp_mobile_goal()
    # robot.scoring_mechanism.spin_motor_at_speed(100)
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-102.942, 45.0), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-103.111, -10.4), use_back=True
    )

    robot.drivetrain.move_to_point(Translation2d.from_centimeters(-133.422, -27.9))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-90.121, -2.9), use_back=True
    )
...
def positive_point_based(robot):
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-32.0, 0.0), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-101.282, -40.0), use_back=True
    )
...
def skills_alliance_stake_point_based(robot):
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-0.0, 20.0), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-0.0, -50.0), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-50.0, -50.0), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    time.sleep(0.5)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-116.947, -48.071), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-129.447, -26.42), use_back=True
    )
    time.sleep(1)
    robot.mobile_goal_clamp.release_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(76.04, -48.538), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(151.04, -28.538), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(172.253, -7.324), use_back=True
    )
    robot.mobile_goal_clamp.release_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(31.024, -316.395), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-38.258, -276.395), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-108.968, -347.106), use_back=True
    )
...
def new_skills_alliance_stake_point_based(robot: Robot):
    ...
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(32.0, -60.0), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    stop_and_sleep(robot, 0.5)
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(149.629, -131.629), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(32.629, -131.629), use_back=True
    )
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(32.629, -161.629))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(32.629, -118.629), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-6.262, -157.52), use_back=True
    )
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.stop_motor()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(22.73, 56.471), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(-100)
    stop_and_sleep(robot, 0.2)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(143.51, 131.989), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(20.51, 131.989), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-16.26, 168.758), use_back=True
    )
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.set_speed(-100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(259.926, 20.991), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(257.197, 139.326), use_back=True
    )
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(297.197, 139.326))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(267.197, 139.326), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(302.553, 174.681), use_back=True
    )
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.scoring_mechanism.stop_motor()
    ...
    schedule_function(
        1, lambda: robot.wall_stake_mechanism.transition_to(WallStakeState.LOW_SCORING)
    )
    # robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(1.6, 5))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-77.972, 182.91), use_back=True
    )
...
def win_point_point_based(robot):
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-40.0, 0.0), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-40.0, 20.0), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(17.851, -73.944), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(72.642, -103.738), use_back=True
    )
...
def positive_win_point_point_based(robot):
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-38.0, 0.0), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-38.0, -20.0), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(19.851, 68.944), use_back=True
    )
...
def negative_4_rings_and_touch_point_based(robot):
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(70.905, -103.889), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(84.441, -107.425), use_back=True
    )
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(1.5, 1.4))
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(89.441, -107.425))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-10.559, -107.425), use_back=True
    )
...
def positive_2_mobile_goal_point_based(robot):
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(129.604, -64.279), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(70, 100))
    ...
    robot.drivetrain.trapezoidal_profile = TrapezoidProfile(Constraints(70, 30))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(94.604, -14.279), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
...
def win_point_states_point_based(robot):
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(140.426, -42.426), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(105.426, 12.574), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(74.785, 38.285), use_back=True
    )
...
def second_win_point_states_point_based(robot):
    ...
    stop_and_sleep(robot, 0.25)
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(4.5, -5.362), use_back=True
    )
    robot.wall_stake_mechanism.transition_to(WallStakeState.DOCKED)
    stop_and_sleep(robot, 0.2)
    robot.scoring_mechanism.set_speed(100)
    schedule_function(
        0.3,
        lambda: robot.scoring_mechanism.intake_until_ring()
        or robot.scoring_mechanism.set_speed(100)
        or time.sleep(0.25)
        or robot.scoring_mechanism.intake_until_ring(),
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(33.178, 35.595), use_back=True
    )
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(100.353, -31.58), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(9.385, -113.768), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-21.257, -139.479), use_back=True
    )
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(116.714, -156.717), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
...
def third_win_point_states_point_based(robot):
    ...
    schedule_function(
        0.3,
        lambda: robot.scoring_mechanism.intake_until_ring()
        or robot.scoring_mechanism.intake_until_no_ring()
        or robot.scoring_mechanism.intake_until_ring(),
    )
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(21.707, 19.212))
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(50.386, 60.17))
    ...
    robot.scoring_mechanism.stop_motor()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(98.292, -19.042), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    robot.scoring_mechanism.set_speed(100)
    stop_and_sleep(robot, 0.5)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(141.292, -74.042), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(31.292, -74.042), use_back=True
    )
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-11.134, -116.468), use_back=True
    )
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(3.008, -102.326), use_back=True
    )
    robot.wall_stake_mechanism.transition_to(WallStakeState.LOW_SCORING)
...
def negative_full_mobile_goal_point_based(robot):
    ...
    robot.mobile_goal_clamp.release_mobile_goal()
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(60.0, -0.0), use_back=True
    )
    robot.mobile_goal_clamp.clamp_mobile_goal()
    stop_and_sleep(robot, 0.25)
    robot.scoring_mechanism.set_speed(100)
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(63.993, 3.009), use_back=True
    )
    ...
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-1.007, 68.009), use_back=True
    )
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(-43.433, 110.435))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-29.291, 96.293), use_back=True
    )
    robot.drivetrain.move_to_point(Translation2d.from_centimeters(-50.504, 117.507))
    robot.drivetrain.move_to_point(
        Translation2d.from_centimeters(-15.149, 82.151), use_back=True
    )
