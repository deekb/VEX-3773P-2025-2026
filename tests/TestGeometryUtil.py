...
class TestGeometryUtil(unittest.TestCase):
    ...
    def test_area_triangle(self):
        self.assertAlmostEqual(GeometryUtil.area_triangle((0, 0), (3, 0), (3, 4)), 6.0, places=5)
        self.assertAlmostEqual(GeometryUtil.area_triangle((0, 0), (0, 3), (4, 3)), 6.0, places=5)
    ...
    def test_intersection_point(self):
        ...
        self.assertIsNone(GeometryUtil.intersection_point((0, 0), (1, 1), (2, 2), (3, 3)))
    ...
    def test_circle_circumference(self):
        self.assertAlmostEqual(GeometryUtil.circle_circumference(5), 31.41592653589793, places=5)
    ...
    def test_closest_point_on_line(self):
        ...
        for point, line_start, line_end, expected_closest_point in test_cases:
            with self.subTest(point=point, line_start=line_start, line_end=line_end):
                closest_point = GeometryUtil.closest_point_on_line(point, line_start, line_end)
